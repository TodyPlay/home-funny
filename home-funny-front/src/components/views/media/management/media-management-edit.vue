<template>
    <div>
        <el-form ref="form" :model="multiMedia" :rules="rules" @submit="submit" :disabled="loading"
            ...
            <el-row>
                <el-col>
                    <el-button type="primary" :loading="loading" :icon="select" native-type="submit" plain>保存
                    </el-button>
